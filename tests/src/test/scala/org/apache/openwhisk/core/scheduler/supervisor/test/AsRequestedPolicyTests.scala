...
class AsRequestedPolicyTests extends TestKit(ActorSystem("WatcherService"))
  ...
  it should "Wait to have some ready containers to remove them" in {
    ...
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(AddContainer, 2)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3+ 3, parameters._4) shouldBe DecisionResults(AddContainer, 2)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3+ 3, parameters._4) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3 + 5, parameters._4) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(Skip, 0)
  ...
  it should "Respect the ready containers threshold" in{
    ...
    supervisor.elaborate(parameters._1, parameters._2, parameters._3+1, parameters._4) shouldBe DecisionResults(AddContainer, 1)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3+1, parameters._4) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A"), parameters._2, parameters._3+1, Set("A")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A","B"), parameters._2, parameters._3+2, Set("A","B")) shouldBe DecisionResults(AddContainer, 1)
    supervisor.elaborate(Set("A","B"), parameters._2, parameters._3+1, Set("A","B")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A","B","C","D"), parameters._2, parameters._3+1, Set("A","B","C","D")) shouldBe DecisionResults(RemoveReadyContainer(Set("A")), 0)
    supervisor.elaborate(Set("B","C","D"), parameters._2, parameters._3+1, Set("B","C","D")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("B","C","D"), parameters._2, 6, Set("B","C","D")) shouldBe DecisionResults(AddContainer, 1)
  ...
  it should "Respect the minimum containers threshold" in{
    ...
    supervisor.elaborate(parameters._1, parameters._2, parameters._3 + 1, parameters._4) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A"), parameters._2 , parameters._3+1, Set("A")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A", "B"), parameters._2 , parameters._3+3, Set("A", "B")) shouldBe DecisionResults(AddContainer, 1)
    supervisor.elaborate(Set("A", "B"), parameters._2 , parameters._3+5, Set("A", "B")) shouldBe DecisionResults(AddContainer, 1)
  ...
  it should "Remove containers only if there are sufficient ready containers" in {
    ...
    supervisor.elaborate(parameters._1, parameters._2, parameters._3+3, parameters._4) shouldBe DecisionResults(AddContainer, 2)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3+1, parameters._4) shouldBe DecisionResults(Skip,0)
    supervisor.elaborate(parameters._1++Set("A"), parameters._2, parameters._3+1, parameters._4++Set("A")) shouldBe DecisionResults(Skip,0)
    supervisor.elaborate(parameters._1++Set("A","B","C"), parameters._2, parameters._3+1, parameters._4++Set("A","B","C")) shouldBe DecisionResults(Skip,0)
    supervisor.elaborate(parameters._1++Set("A","B","C","D"), parameters._2, parameters._3+1, parameters._4++Set("A","B","C")) shouldBe DecisionResults(Skip,0)
    supervisor.elaborate(parameters._1++Set("A","B","C","D"), parameters._2, parameters._3+1, parameters._4++Set("A","B","C","D")) shouldBe DecisionResults(RemoveReadyContainer(Set("A")),0)
  }
