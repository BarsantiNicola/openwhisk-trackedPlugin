...
class AsRequestedPolicyTests extends TestKit(ActorSystem("WatcherService"))
  ...
  it should "Manage containers using maxWorkers and minWorkers" in {
    ...
    supervisor.elaborate(Set("A", "B"), parameters._2, parameters._3 + 2, Set("A", "B"), None) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A","B"), parameters._2, parameters._3 + 1, Set("A","B"), None) shouldBe DecisionResults(RemoveReadyContainer(Set("A")), 0)
    supervisor.elaborate(Set("B"), parameters._2, parameters._3 + 6, Set("B"), None) shouldBe DecisionResults(AddContainer, 3)
  ...
  it should "Respect the minimum containers threshold" in{
    ...
    supervisor.elaborate(Set("B"), parameters._2, parameters._3, Set("B"), None) shouldBe DecisionResults(RemoveReadyContainer(Set("B")), 0)
    supervisor.elaborate(Set("C"), 0, parameters._3, Set("C"), None) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("C", "D"), 0, parameters._3, Set("C", "D"), None) shouldBe DecisionResults(Skip, 0)
  }
