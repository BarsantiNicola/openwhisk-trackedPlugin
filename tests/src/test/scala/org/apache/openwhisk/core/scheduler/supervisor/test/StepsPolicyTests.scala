...
class StepsPolicyTests extends TestKit(ActorSystem("WatcherService"))
  ...
  it should "Manage minWorkers, maxWorkers, readyWorkers equal to 0" in{
    ...
    val config = SchedulingSupervisorConfig(enableSupervisor = true, 0, 0, 0, "Steps", 2, 0, "AcceptAll", 2, 500)
  ...
  it should "Manage minWorkers, maxWorkers, readyWorkers equal to 1" in{
    val stateRegistry: StateRegistry = new MockStateRegistry(namespace, action)
    val config = SchedulingSupervisorConfig(enableSupervisor = true, 1, 1, 1, "Steps", 2, 0, "AcceptAll", 2, 500)
    val supervisor: QueueSupervisor = new QueueSupervisor(namespace, action, config, stateRegistry)
    val parameters: (Set[String], Int, Int, Set[String]) = createEnv(0, 0, 0, 0, 1, 0, supervisor)
  ...
  it should "Manage minWorkers, maxWorkers, readyWorkers equal to n" in {
    val stateRegistry: StateRegistry = new MockStateRegistry(namespace, action)
    val config = SchedulingSupervisorConfig(enableSupervisor = true, 5, 5, 5, "Steps", 2, 0, "AcceptAll", 2, 500)
    val supervisor: QueueSupervisor = new QueueSupervisor(namespace, action, config, stateRegistry)
    val parameters: (Set[String], Int, Int, Set[String]) = createEnv(0, 0, 0, 0, 1, 0, supervisor)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(AddContainer, 2)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A","B"), parameters._2, parameters._3, Set("A","B")) shouldBe DecisionResults(AddContainer, 2)
    supervisor.elaborate(Set("A","B"), parameters._2, parameters._3, Set("A","B")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A","B","C","D"), parameters._2, parameters._3, Set("A","B","C","D")) shouldBe DecisionResults(AddContainer, 1)
  ...
  it should "Manage containers using only maxWorkers" in{
    val stateRegistry: StateRegistry = new MockStateRegistry(namespace, action)
    val config = SchedulingSupervisorConfig(enableSupervisor = true, 5, 0, 0, "Steps", 2, 0, "AcceptAll", 2, 500)
    val supervisor: QueueSupervisor = new QueueSupervisor(namespace, action, config, stateRegistry)
    val parameters: (Set[String], Int, Int, Set[String]) = createEnv(0, 0, 0, 0, 0, 0, supervisor)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3 + 1, parameters._4) shouldBe DecisionResults(AddContainer, 2)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3 + 2, parameters._4) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A","B"), parameters._2, parameters._3 + 2, Set("A","B")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A","B"), parameters._2, parameters._3 + 1, Set("A","B")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A","B"), parameters._2, parameters._3 + 3, Set("A","B")) shouldBe DecisionResults(AddContainer, 2)
    supervisor.elaborate(Set("A","B","C"), parameters._2, parameters._3, Set("A","B","C")) shouldBe DecisionResults(Skip, 0)
    ...
    supervisor.elaborate(Set("C","D"), parameters._2, parameters._3, Set("C","D")) shouldBe DecisionResults(RemoveReadyContainer(Set("C","D")), 0)
    supervisor.clean()
  }

  it should "Manage containers using using maxWorkers and minWorkers" in {
    val stateRegistry: StateRegistry = new MockStateRegistry(namespace, action)
    val config = SchedulingSupervisorConfig(enableSupervisor = true, 5, 2, 0, "Steps", 4, 0, "AcceptAll", 2, 500)
    val supervisor: QueueSupervisor = new QueueSupervisor(namespace, action, config, stateRegistry)
    val parameters: (Set[String], Int, Int, Set[String]) = createEnv(0, 0, 0, 0, 0, 0, supervisor)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(AddContainer, 4)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3 + 1, parameters._4) shouldBe DecisionResults(Skip, 0)
  ...
  it should "Manage containers using using maxWorkers and readyWorkers" in {
    val stateRegistry: StateRegistry = new MockStateRegistry(namespace, action)
    val config = SchedulingSupervisorConfig(enableSupervisor = true, 5, 0, 2, "Steps", 3, 0, "AcceptAll", 2, 500)
    val supervisor: QueueSupervisor = new QueueSupervisor(namespace, action, config, stateRegistry)
    val parameters: (Set[String], Int, Int, Set[String]) = createEnv(0, 0, 0, 0, 0, 0, supervisor)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(AddContainer, 3)
    supervisor.elaborate(Set( "A", "B", "C"), parameters._2, parameters._3 + 1, Set( "A", "B", "C")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set( "A", "B", "C"), parameters._2, parameters._3 + 2, Set( "A", "B", "C")) shouldBe DecisionResults(AddContainer, 2)
    supervisor.elaborate(Set( "A", "B", "C", "D"), parameters._2, parameters._3 + 1, Set( "A", "B", "C", "D")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A", "B", "C", "D","E"), parameters._2, parameters._3 + 3, Set("A", "B", "C", "D","E")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A", "B", "C", "D","E"), parameters._2, parameters._3 + 1, Set("A", "B", "C", "D","E")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set( "A", "B", "C", "D","E"), parameters._2, parameters._3, Set( "A", "B", "C", "D","E")) shouldBe DecisionResults(RemoveReadyContainer(Set("E","A","B")), 0)
    supervisor.elaborate(Set( "D","E"), parameters._2, parameters._3, Set( "D","E")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set( "D","E"), parameters._2, parameters._3 + 1, Set( "C","D")) shouldBe DecisionResults(AddContainer, 3)
    supervisor.clean()
  }

  it should "Manage containers using using maxWorkers minWorkers and readyWorkers in every possible combination" in {
    val stateRegistry: StateRegistry = new MockStateRegistry(namespace, action)
    val config = SchedulingSupervisorConfig(enableSupervisor = true, 5, 1, 2, "Steps", 1, 0, "AcceptAll", 2, 500)
    val supervisor: QueueSupervisor = new QueueSupervisor(namespace, action, config, stateRegistry)
    val parameters: (Set[String], Int, Int, Set[String]) = createEnv(0, 0, 0, 0, 0, 0, supervisor)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(AddContainer, 1)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A","B"), parameters._2, parameters._3 + 1, Set("A","B")) shouldBe DecisionResults(AddContainer, 1)
    supervisor.elaborate(Set("A","B"), parameters._2, parameters._3 + 4, Set("A","B")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A","B"), parameters._2, parameters._3 , Set("A","B")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A","B","C"), parameters._2, parameters._3 , Set("A","B","C")) shouldBe DecisionResults(RemoveReadyContainer(Set("A")), 0)
    supervisor.elaborate(Set("B","C"), parameters._2, parameters._3+5 , Set("B","C")) shouldBe DecisionResults(AddContainer, 1)
    supervisor.elaborate(Set("B","C","D"), parameters._2, parameters._3+5 , Set("B","C","D")) shouldBe DecisionResults(AddContainer, 1)
    supervisor.elaborate(Set("B","C","D","E"), parameters._2, parameters._3+5 , Set("B","C","D","E")) shouldBe DecisionResults(AddContainer, 1)
    supervisor.elaborate(Set("B","C","D","E","F"), parameters._2, parameters._3+5 , Set("B","C","D","E","F")) shouldBe DecisionResults(Skip,0)
    supervisor.clean()
  }

  it should "Respect the ready containers threshold" in{
    val stateRegistry: StateRegistry = new MockStateRegistry(namespace, action)
    val config = SchedulingSupervisorConfig(enableSupervisor = true, 4,0,2, "Steps", 2, 0, "AcceptAll", 2, 500 )
    val supervisor: QueueSupervisor = new QueueSupervisor(namespace, action, config, stateRegistry)
    val parameters: (Set[String], Int, Int, Set[String]) = createEnv(0, 0, 0, 0, 0, 0, supervisor)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(AddContainer, 2)
  ...
  it should "Respect the minimum containers threshold" in{
    val stateRegistry: StateRegistry = new MockStateRegistry(namespace, action)
    val config = SchedulingSupervisorConfig(enableSupervisor = true, 6,2,0, "Steps", 3, 0, "AcceptAll", 2, 500 )
    val supervisor: QueueSupervisor = new QueueSupervisor(namespace, action, config, stateRegistry)
    val parameters: (Set[String], Int, Int, Set[String]) = createEnv(0, 0, 0, 0, 0, 0, supervisor)
    supervisor.elaborate(parameters._1, parameters._2, parameters._3, parameters._4) shouldBe DecisionResults(AddContainer, 3)
    supervisor.elaborate(Set("A", "B","C"), parameters._2, parameters._3 + 1, Set("A", "B","C")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A", "B","C"), parameters._2, parameters._3+3, Set("A", "B","C")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A", "B","C"), parameters._2, parameters._3+5, Set("A", "B","C")) shouldBe DecisionResults(AddContainer, 3)
    supervisor.elaborate(Set("A", "B","C","D","E","F"), parameters._2, parameters._3+4, Set("A", "B","C","D","E","F")) shouldBe DecisionResults(Skip, 0)
    supervisor.elaborate(Set("A", "B","C","D","E","F"), parameters._2, parameters._3+3, Set("A", "B","C","D","E","F")) shouldBe DecisionResults(RemoveReadyContainer(Set("E","F","A")), 0)
    supervisor.elaborate(Set("B", "C", "D"), parameters._2, parameters._3, Set("B", "C", "D")) shouldBe DecisionResults(RemoveReadyContainer(Set("B")),0)
  }

  it should "React to a dynamic change of the parameters" in{
    val stateRegistry: StateRegistry = new MockStateRegistry(namespace, action)
    val config = SchedulingSupervisorConfig(enableSupervisor = true, 1, 1, 0, "Steps", 2, 0, "AcceptAll", 2, 500)
    val supervisor: QueueSupervisor = new QueueSupervisor(namespace, action, config, stateRegistry)
    val parameters: (Set[String], Int, Int, Set[String]) = createEnv(0, 0, 0, 0, 0, 0, supervisor)
    ...
    supervisor.elaborate(Set("A","B"), parameters._2, 3, Set("A","B")) shouldBe DecisionResults(Skip, 0)
    supervisor.setMinWorkers(0)
    supervisor.elaborate(Set("A","B"), parameters._2, 0, Set("A","B")) shouldBe DecisionResults(RemoveReadyContainer(Set("A","B")), 0)
    ...
    supervisor.elaborate(Set("C"), parameters._2, 0, Set("C")) shouldBe DecisionResults(AddContainer, 2)
    supervisor.setReadyWorkers(3)
    supervisor.elaborate(Set("C","D","E"), parameters._2, 1, Set("C","D","E")) shouldBe DecisionResults(AddContainer, 1)
    supervisor.elaborate(Set("C","D","E","F"), parameters._2, 2, Set("C","D","E","F")) shouldBe DecisionResults(Skip, 0)
    supervisor.setMaxWorkers(5)
    supervisor.elaborate(Set("C","D","E","F"), parameters._2, 2, Set("C","D","E","F")) shouldBe DecisionResults(AddContainer, 1)
    supervisor.setMinWorkers(0)
    ...
    supervisor.elaborate(Set("A","B","C","D","E"), parameters._2, 2, Set("A","B","C","D","E")) shouldBe DecisionResults(RemoveReadyContainer(Set("E","A")), 0)
    supervisor.elaborate(Set("B","C","D"), parameters._2, 0, Set("B","C","D")) shouldBe DecisionResults(RemoveReadyContainer(Set("B","C")), 0)
